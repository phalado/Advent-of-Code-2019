...
class SearchTree
  ...
  # def printbranch(node)
  #   printbranch(node.left) unless node.left.nil?
  #   printbranch(node.down) unless node.down.nil?
  #   p "#{node.x} #{node.y}"
  #   printbranch(node.right) unless node.right.nil?
  #   printbranch(node.up) unless node.up.nil?
  #   return
  # end
end
